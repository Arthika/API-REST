...
//
// 1) 'gson-xxx.jar'       with MAVEN dependency: groupId 'com.google.code.gson', artifactId 'gson' and version 2.3.1 
//                         or download from main project at 'https://github.com/google/gson'
//
...
public class Main {
	...
	private static final String URL = "http://certification.arthikatrading.com:81/cgi-bin/IHFTRestStreamer/getPrice";
	
	public static class hftRequest {
		public getPriceRequest  getPrice;
		
		public hftRequest( String user, String password, int customer, List<String> security ) {
			this.getPrice = new getPriceRequest(user, password, customer, security); 
		}
	}
    ...
    public static class getPriceRequest
    {
        ...
        public getPriceRequest( String user, String password, int customer, List<String> security ) {
        	this.user = user;
    ...
    public static void main(String[] args) throws IOException {
		...
		hftRequest hftrequest = new hftRequest("fedenice", "fedenice", 11, Arrays.asList("EUR_USD", "GBP_USD"));

		try {
			HttpPost httpRequest = new HttpPost(URL);
			StringEntity request = new StringEntity(gson.toJson(hftrequest));
                    ...
                    if (status >= 200 && status < 300) {
                        ...
                        try {
                            ...
                            while ((line = bufferedReader.readLine()) != null) {
                            	...
                            	hftResponse response = gson.fromJson(line, hftResponse.class);
